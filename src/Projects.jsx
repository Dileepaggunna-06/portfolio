...
function Projects() {
  const projects = [
    {
      title: "SkyNote",
      tech: "React • Node.js • Express.js • Collaboration",
      desc: "My major project — a collaborative document-sharing platform where users can create, view, and edit documents with friends or groups.",
    },
    {
      title: "NearHelp",
